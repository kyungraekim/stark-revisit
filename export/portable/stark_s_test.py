...
class ExportStarkSTest(test_utils.DualModelTest):
    ...
    def test_backbone(self):
        ...
        self.diff_inside(v_o['feat'], v_p[0], self.epsilon)
        self.diff_inside(v_o['mask'], v_p[1], self.epsilon)
        self.diff_inside(v_o['pos'], v_p[2], self.epsilon)
    ...
    def test_transformer(self):
        ...
        self.diff_inside(out_o['pred_boxes'], out_p['pred_boxes'], self.epsilon)
        self.diff_inside(coord_o, coord_p, self.epsilon)
        self.diff_inside(embed_o, embed_p, self.epsilon)
